...
export default function Login() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      navigate('/dashboard'); // A ser implementado
    } catch (err) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-green-100 flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-white rounded-3xl shadow-xl overflow-hidden border border-green-50">
        <div className="p-8">
          ...
          <h2 className="text-3xl font-extrabold text-center text-gray-800 mb-2 tracking-tight">Bem-vindo(a) de volta!</h2>
          <p className="text-center text-gray-500 mb-8 font-medium">Acesse sua conta para continuar no CoffeCare</p>
          ...
          <div className="mt-6">
            <button
              type="button"
              className="w-full inline-flex justify-center py-3.5 px-4 border border-gray-200 rounded-2xl shadow-sm bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 hover:shadow-md transition-all active:bg-gray-100"
            >
          ...
          <div className="mt-8 text-center text-sm">
            <span className="text-gray-500 font-medium">Novo na plataforma? </span>
